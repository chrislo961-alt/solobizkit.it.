(function(){
  ...
  ready(function(){
    ...
    if(hero){
      ...
      hero.innerHTML=`
        <div class="hero-copy">
          <span class="home-badge">FROM SOLO TO GROWING — ONE BUSINESS TOOLKIT</span>
          <h1>Start solo. Grow without switching tools.</h1>
          <p>SoloBizKit brings calculators, invoicing, documents and business admin into one practical toolkit. Start with the free tools, then move into Pro for customers, estimates, recurring invoices and payments as your business grows.</p>
          <div class="home-actions">
            <a class="primary" href="#popular">Explore free tools</a>
            <a class="secondary pro" href="/pro-pricing/">See SoloBizKit Pro</a>
          </div>
          <div class="hero-proof"><span>✓ No signup for free tools</span><span>✓ 14-day Pro trial</span><span>✓ Built for solo businesses & growing teams</span></div>
        </div>
