...
const files = await Promise.all([
  'backend.js','team-access.js','workspace-ui.js','payment-actions.js','reminder-actions.js','customer-history.js','document-attachments.js','activity-feed.js','spreadsheet-transfer-workspace.js','email-actions-v2.js','pro-app.js','customer-portal-actions.js','customer-workspace-actions.js','bootstrap.js'
...
need('bootstrap.js',"20260907-7",'current cache version');
need('bootstrap.js','version: 18','boot version 18');
...
console.log('Pro team/workspace audit passed: active workspace ownership, roles, invitations, payments, reminders, attachments, activity, Excel paths and read-only UI are workspace-aware.');