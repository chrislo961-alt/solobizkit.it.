...
function formDataToSettings(form) {
  ...
  return {
    ...
    notifyEstimateResponses: data.get('notifyEstimateResponses') === 'on',
    notifyInvoicePaid: data.get('notifyInvoicePaid') === 'on',
  };
}
