...
async function renderBilling(){
  ...
  try{
    ...
    const trialNotice=trialing?`<div class="trial-billing-note"><strong>Your 14-day Pro trial is active.</strong><span>${trialDays===null?'Trial active':`${trialDays} day${trialDays===1?'':'s'} left`} · ends ${esc(formatDate(sub.trial_end_at))}.</span></div>`:'';
